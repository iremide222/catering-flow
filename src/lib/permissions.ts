...
const ROUTE_ROLES: Array<{ prefix: string; roles: Role[] }> = [
  ...
  { prefix: "/app/attendance", roles: ["admin", "manager", "accountant"] },
  { prefix: "/app/payroll", roles: ["admin", "manager", "accountant"] },
  { prefix: "/app/menus", roles: ["admin", "manager", "store_manager"] },
